...
static void test_p101_accept(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            struct sockaddr native_argument_3 = {0};
            socklen_t       native_argument_4 = {0};
            int             native_result     = p101_accept(native_env, native_err, 0, &native_argument_3, &native_argument_4);
            (void)native_result;
...
static void test_p101_bind(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            struct sockaddr native_argument_3 = {0};
            int             native_result     = p101_bind(native_env, native_err, 0, &native_argument_3, 0);
            (void)native_result;
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
            _Exit(EXIT_SUCCESS);
...
static void test_p101_connect(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            struct sockaddr native_argument_3 = {0};
            int             native_result     = p101_connect(native_env, native_err, 0, &native_argument_3, 0);
            (void)native_result;
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
            _Exit(EXIT_SUCCESS);
...
static void test_p101_ether_aton(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            struct ether_addr *native_result = p101_ether_aton(native_env, native_err, "p101");
            (void)native_result;
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
            _Exit(EXIT_SUCCESS);
...
static void test_p101_ether_line(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            int  native_result               = p101_ether_line(native_env, native_err, "p101", native_argument_3, native_argument_4);
            (void)native_result;
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
            _Exit(EXIT_SUCCESS);
...
static void test_p101_getaddrinfo(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            struct addrinfo  native_argument_4 = {0};
            struct addrinfo *native_argument_5 = NULL;
            int              native_result     = p101_getaddrinfo(native_env, native_err, "p101", "p101", &native_argument_4, &native_argument_5);
            (void)native_result;
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
            _Exit(EXIT_SUCCESS);
...
static void test_p101_getnameinfo(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            struct sockaddr native_argument_2           = {0};
            char            native_argument_4[PATH_MAX] = {0};
            char            native_argument_6[PATH_MAX] = {0};
            int             native_result               = p101_getnameinfo(native_env, native_err, &native_argument_2, 0, native_argument_4, 0, native_argument_6, 0, 0);
            (void)native_result;
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
            _Exit(EXIT_SUCCESS);
...
static void test_p101_getpeername(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            struct sockaddr native_argument_3 = {0};
            socklen_t       native_argument_4 = {0};
            int             native_result     = p101_getpeername(native_env, native_err, 0, &native_argument_3, &native_argument_4);
            (void)native_result;
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
            _Exit(EXIT_SUCCESS);
...
static void test_p101_getsockname(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            struct sockaddr native_argument_3 = {0};
            socklen_t       native_argument_4 = {0};
            int             native_result     = p101_getsockname(native_env, native_err, 0, &native_argument_3, &native_argument_4);
            (void)native_result;
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
            _Exit(EXIT_SUCCESS);
...
static void test_p101_getsockopt(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            socklen_t     native_argument_6       = {0};
            int           native_result           = p101_getsockopt(native_env, native_err, 0, 0, 0, native_argument_5, &native_argument_6);
            (void)native_result;
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
            _Exit(EXIT_SUCCESS);
...
static void test_p101_if_indextoname(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            char *native_result               = p101_if_indextoname(native_env, native_err, 0, native_argument_3);
            (void)native_result;
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
            _Exit(EXIT_SUCCESS);
...
static void test_p101_if_nametoindex(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            unsigned int native_result = p101_if_nametoindex(native_env, native_err, "p101");
            (void)native_result;
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
            _Exit(EXIT_SUCCESS);
...
static void test_p101_inet_addr(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            in_addr_t native_result = p101_inet_addr(native_env, native_err, "p101");
            (void)native_result;
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
            _Exit(EXIT_SUCCESS);
...
static void test_p101_inet_aton(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            int            native_result     = p101_inet_aton(native_env, native_err, "p101", &native_argument_3);
            (void)native_result;
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
            _Exit(EXIT_SUCCESS);
...
static void test_p101_inet_net_ntop(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            char *native_result               = p101_inet_net_ntop(native_env, native_err, 0, NULL, 0, native_argument_5, 0);
            (void)native_result;
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
            _Exit(EXIT_SUCCESS);
...
static void test_p101_inet_net_pton(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            int           native_result           = p101_inet_net_pton(native_env, native_err, 0, "p101", native_argument_4, 0);
            (void)native_result;
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
            _Exit(EXIT_SUCCESS);
...
static void test_p101_inet_network(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            in_addr_t native_result = p101_inet_network(native_env, native_err, "p101");
            (void)native_result;
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
            _Exit(EXIT_SUCCESS);
...
static void test_p101_inet_ntop(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            char        native_argument_4[PATH_MAX] = {0};
            const char *native_result               = p101_inet_ntop(native_env, native_err, 0, NULL, native_argument_4, 0);
            (void)native_result;
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
            _Exit(EXIT_SUCCESS);
...
static void test_p101_inet_pton(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            unsigned char native_argument_4[4096] = {0};
            int           native_result           = p101_inet_pton(native_env, native_err, 0, "p101", native_argument_4);
            (void)native_result;
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
            _Exit(EXIT_SUCCESS);
...
static void test_p101_listen(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            int native_result = p101_listen(native_env, native_err, 0, 0);
            (void)native_result;
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
            _Exit(EXIT_SUCCESS);
...
static void test_p101_recv(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            ssize_t       native_result           = p101_recv(native_env, native_err, 0, native_argument_3, 0, 0);
            (void)native_result;
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
            _Exit(EXIT_SUCCESS);
...
static void test_p101_recvfrom(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            unsigned char   native_argument_3[4096] = {0};
            struct sockaddr native_argument_6       = {0};
            socklen_t       native_argument_7       = {0};
            ssize_t         native_result           = p101_recvfrom(native_env, native_err, 0, native_argument_3, 0, 0, &native_argument_6, &native_argument_7);
            (void)native_result;
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
            _Exit(EXIT_SUCCESS);
...
static void test_p101_recvmsg(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            ssize_t       native_result     = p101_recvmsg(native_env, native_err, 0, &native_argument_3, 0);
            (void)native_result;
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
            _Exit(EXIT_SUCCESS);
...
static void test_p101_send(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            ssize_t native_result = p101_send(native_env, native_err, 0, NULL, 0, 0);
            (void)native_result;
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
            _Exit(EXIT_SUCCESS);
...
static void test_p101_sendmsg(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            struct msghdr native_argument_3 = {0};
            ssize_t       native_result     = p101_sendmsg(native_env, native_err, 0, &native_argument_3, 0);
            (void)native_result;
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
            _Exit(EXIT_SUCCESS);
...
static void test_p101_sendto(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            struct sockaddr native_argument_6 = {0};
            ssize_t         native_result     = p101_sendto(native_env, native_err, 0, NULL, 0, 0, &native_argument_6, 0);
            (void)native_result;
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
            _Exit(EXIT_SUCCESS);
...
static void test_p101_setsockopt(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            int native_result = p101_setsockopt(native_env, native_err, 0, 0, 0, NULL, 0);
            (void)native_result;
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
            _Exit(EXIT_SUCCESS);
...
static void test_p101_shutdown(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            int native_result = p101_shutdown(native_env, native_err, 0, 0);
            (void)native_result;
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
            _Exit(EXIT_SUCCESS);
...
static void test_p101_sockatmark(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            int native_result = p101_sockatmark(native_env, native_err, 0);
            (void)native_result;
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
            _Exit(EXIT_SUCCESS);
...
static void test_p101_socket(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            int native_result = p101_socket(native_env, native_err, 0, 0, 0);
            (void)native_result;
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
            _Exit(EXIT_SUCCESS);
...
static void test_p101_socketpair(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            int native_result     = p101_socketpair(native_env, native_err, 0, 0, 0, &native_argument_5);
            (void)native_result;
            p101_env_destroy(native_env);
            p101_error_destroy(native_err);
            _Exit(EXIT_SUCCESS);
